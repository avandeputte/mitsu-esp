...
class MitsubishiHeatPump : public esphome::PollingComponent, public esphome::climate::Climate {
    ...
    public:
        ...
        void set_fan_mode(esphome::select::Select *fan_mode_select);
    ...
    protected:
        ...
        void update_fan_mode(const std::string &mode);
        std::string vertical_swing_state_;
        std::string horizontal_swing_state_;
        std::string fan_mode_state_;
